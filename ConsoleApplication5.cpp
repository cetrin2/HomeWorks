...
int main()
{
	...
	int eastern_year_index;		//индекс года для определения соответсвия восточному календарю
	...
	//Определяем индекс года по восточному календарю
	eastern_year_index = year % 12;

	//Ищем соответсвие для названия года
